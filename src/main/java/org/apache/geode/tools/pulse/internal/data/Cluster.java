...
public class Cluster extends Thread {
  ...
  private Map<String, Statement> clusterStatementMap =
      new ConcurrentHashMap<String, Statement>();
  ...
  public static class Member {
    ...
    private HashMap<String, Region> memberRegions = new HashMap<String, Region>();
    private HashMap<String, Client> memberClientsHMap =
    ...
    private List<AsyncEventQueue> asyncEventQueueList =
        new ArrayList<AsyncEventQueue>();
    ...
    public void updateMemberClientsHMap(HashMap<String, Client> memberClientsHM) {
      ...
      for (Map.Entry<String, Client> entry : memberClientsHMap.entrySet()) {
        String clientId = entry.getKey();
